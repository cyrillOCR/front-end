...
class App extends Component {
  ...
  imageUploadCallback(files) {
    return new Promise((resolved, rejected) => {
      ...
      return axios.post('https://preprocessing.localtunnel.me/convertPdf', {
  ...
  segmentationCallback({ page, imageURI, contrastFactor, applyDilation, applyNoiseReduction, segmentationFactor, separationFactor }) {
    ...
    return axios.post("https://preprocessing.localtunnel.me/addImage", {
  ...
  recognitionCallback({ page, imageURI }) {
    ...
    return axios.post('https://feature.localtunnel.me/feature', {
